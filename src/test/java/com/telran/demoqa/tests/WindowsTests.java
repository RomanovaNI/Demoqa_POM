...
public class WindowsTests extends TestBase {
    ...
    public void newTabTest(){
        ...
        Assert.assertTrue(new BrowserWindowsPage(driver).getTextFromNewTab().
                contains("sample"));
    ...
    public void newWindowMsgTest(){
        new BrowserWindowsPage(driver).clickOnNewWindowMsgBtn();
        Assert.assertTrue(new BrowserWindowsPage(driver).getMessageFromNewTab().
                contains("increases"));
    }
}
